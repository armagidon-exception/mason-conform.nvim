local utils = require "mason-conform.utils"
local M = {}

-- conform formatter to mason package mapping
-- https://mason-registry.dev/registry/list
M.conform_to_package = utils.read_only {
	["air"] = "air",
	["alejandra"] = "alejandra",
...
M.package_to_conform = utils.read_only(utils.tbl_reverse(M.conform_to_package))
